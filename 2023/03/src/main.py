...
def main():
    assert problem_3a(read_file(Path(__file__).parent.parent / "test_data.txt")) == 4361
    print(problem_3a(read_file(Path(__file__).parent.parent / "data.txt")))


def problem_3a(data: list[list[str]]) -> int:
    """
...
def problem_3b(data: list[list[str]]) -> int:
    """
